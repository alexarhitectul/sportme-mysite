                ...
                <div className="mt-4 overflow-hidden rounded-2xl border border-[#e6e0d2]">
                  <div className="grid grid-cols-[1.35fr_0.55fr_0.55fr_0.55fr] bg-[#f1f2f4] px-2 py-2 text-[11px] font-semibold text-[#1f211f] sm:grid-cols-[1.35fr_0.7fr_0.7fr_0.7fr] sm:px-3 sm:py-2.5 sm:text-xs md:grid-cols-[1.4fr_0.9fr_1fr_1fr] md:px-4 md:py-3 md:text-sm">
                    ...
                    <div className="text-center">
                      ...
                      <div className="mt-1 inline-flex rounded-full border border-[#76b8ff] bg-white px-2 py-0.5 text-[9px] font-normal uppercase tracking-[0.05em] text-[#0d58c8] shadow-[0_4px_12px_rgba(13,88,200,0.12)] sm:text-[10px] md:text-[11px] md:tracking-[0.08em]">
                    ...
                    <div className="text-center">
                      ...
                      <div className="mt-1 inline-flex rounded-full border border-[#b394f0] bg-white px-2 py-0.5 text-[9px] font-normal uppercase tracking-[0.05em] text-[#5e3c9b] shadow-[0_4px_12px_rgba(94,60,155,0.12)] sm:text-[10px] md:text-[11px] md:tracking-[0.08em]">
            ...
            <div className="relative pt-16 lg:pt-0">
              ...
              <div className="grid gap-4 sm:gap-6 lg:grid-cols-3">
                ...
                <div className="relative rounded-[24px] border-2 border-[#1f211f] bg-white p-4 shadow-[0_30px_65px_-38px_rgba(32,33,31,0.75)] sm:rounded-[28px] sm:p-6">
                  ...
                  <div className="mt-3 rounded-xl border border-[#c7aff1] bg-white px-3 py-2 text-sm font-normal uppercase tracking-[0.1em] text-[#5e3c9b] shadow-[0_8px_20px_rgba(94,60,155,0.1)]">
                    {t("pricing.new.pro.limit")}
                  </div>
                  <div className="pointer-events-none relative z-10 mt-4 -mb-10 lg:hidden">
                    <div className="rotate-[-3deg] rounded-xl border-2 border-emerald-300 bg-[linear-gradient(135deg,rgba(7,31,24,0.82),rgba(18,67,48,0.78))] px-3 py-2 text-center shadow-[0_12px_32px_rgba(0,0,0,0.22)]">
